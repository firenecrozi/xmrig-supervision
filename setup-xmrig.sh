...
function info() {
    ...
    echo "
    - Python 3.10+, Git, CMake, libhwloc-dev, libssl-dev, libuv1-dev, build-essential, python3-pip, msr-tools, screen, zip
...
function download_all() {
    ...
    apt update && apt install -y git build-essential python3-pip python3-dev libssl-dev libhwloc-dev libuv1-dev cmake msr-tools screen zip
